...
OPT_MODSEC_CRS_MAX_NUM_ARGS=
OPT_MODSEC_CRS_ARG_NAME_LENGTH=
OPT_MODSEC_CRS_ARG_LENGTH=
OPT_MODSEC_CRS_TOTAL_ARG_LENGTH=
OPT_MODSEC_CRS_MAX_FILE_SIZE=
OPT_MODSEC_CRS_COMBINED_FILE_SIZES=
...
OPT_MODSEC_AUDIT_LOG=${NGINX_LOG_PATH}/modsec_audit.log
