...
![Build Status](https://github.com/TundraSoft/nginx/actions/workflows/ci.yml/badge.svg)
![Docker Pull](https://img.shields.io/github/repo-size/tundrasoft/nginx?color=brightgreen)
![Docker Pull](https://img.shields.io/docker/pulls/tundrasoft/nginx.svg)
![Docker Size](https://img.shields.io/docker/image-size/tundrasoft/nginx/latest?label=docker%20image%20size)
...
## Build
```docker
docker build . --cpuset-cpus 0-3  --no-cache --build-arg NGINX_VERSION=1.21.6 --build-arg ALPINE_VERSION=latest -t tundrasoft/nginx
```
